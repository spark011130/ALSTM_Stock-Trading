...
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        output = self.fc(lstm_out[:, -1, :])  # Use last time step output
        return output
...
def print_and_save_evaluation_results(results, metrics, filename="outputs/LSTM_trading_strategy_evaluation.csv"):
    """
    ...
    :param filename: Name of the file to save results (default: outputs/LSTM_trading_strategy_evaluation.csv)
    """
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("outputs/lstm_model.pth"))
